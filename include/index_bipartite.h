...
class IndexBipartite : public Index {
   ...
   public:
    ...
    void qbaseNNbipartite(const Parameters &parameters, SimpleNeighbor *simple_graph);

    std::pair<uint32_t, uint32_t> SearchQbaseNNBipartiteGraph(const float *query, size_t k, size_t &qid, const Parameters &parameters,
    ...
    std::pair<uint32_t, uint32_t> SearchProjectionGraph(const float *query, size_t k, size_t &qid, const Parameters &parameters,
